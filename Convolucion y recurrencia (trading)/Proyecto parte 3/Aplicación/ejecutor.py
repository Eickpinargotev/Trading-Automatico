...
try:
    Buys_model = load_model(os.path.join(os.path.dirname(__file__), 'models/Buys_model.keras'))  # Cargar modelo de compras
    Sells_model = load_model(os.path.join(os.path.dirname(__file__), 'models/Sells_model.keras'))  # Cargar modelo de ventas
    os.system('cls')
